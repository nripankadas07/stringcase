...
def test_camel_pascal():
    assert to_camel("HelloWorld") == "helloWorld"


def test_camel_http():
    assert to_camel("HTTPServer") == "httpServer"


def test_pascal_empty():
    assert to_pascal("") == ""


def test_pascal_snake():
...
def test_pascal_http():
    assert to_pascal("HTTPServer") == "HttpServer"
